    ...
    view! { cx,
        <main class="p-4 lh-condensed">
            ...
            <ul class="pl-4 pb-2">
                ...
                <li>{"Company: when this policy mentions \"Company,\" \"we,\" \"us,\" or \"our,\" it refers to Marzipan Club, LLC that is responsible for your information under this Privacy Policy."}</li>
                <li>{"Country: where Marzichat or the owners/founders of Marzichat are based, in this case is the United States."}</li>
                <li>{"Customer: refers to the company, organization or person that signs up to use the Marzichat Service to manage the relationships with your consumers or service users"}.</li>
                ...
                <li>{"Personnel: refers to those individuals who are employed by Marzichat or are under contract to perform a service on behalf of one of the parties."}</li>
                ...
                <li>{"Service: refers to the service provided by Marzichat as described in the relative terms (if available) and on this platform."}</li>
            ...
            <h2>{"When does Marzichat use end user information from third parties?"}</h2>
            <p>{"Marzichat will collect End User Data necessary to provide the Marzichat services to our customers."}</p>
            ...
            <h2>{"When does Marzichat use customer information from third parties?"}</h2>
            <p>{"We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a Marzichat customer, we receive information from a third party that provides automated fraud detection services to Marzichat. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings."}</p>
            ...
            <p>{"Marzichat will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above."}</p>
            ...
            <p>{"The rights you have to request updates or corrections to the information Marzichat collects depend on your relationship with Marzichat. Personnel may update or correct their information as detailed in our internal company employment policies."}</p>
            ...
            <h2>{"Personnel"}</h2>
            <p>{"If you are a Marzichat worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants."}</p>
            ...
            <p>{"We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Marzichat or any of its Corporate Affiliates (as defined herein), or that portion of Marzichat or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy."}</p>

            <h2>{"Affiliates"}</h2>
            <p>{"We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, \"Corporate Affiliate\" means any person or entity which directly or indirectly controls, is controlled by or is under common control with Marzichat, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy."}</p>
            ...
            <p>{"This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by Marzichat. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website's own rules and policies. Such third parties may use their own cookies or other methods to collect information about you."}</p>
